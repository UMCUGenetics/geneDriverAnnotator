...
filterVcf <- function(
   ...
   #out.file='/Users/lnguyen/hpc/cuppen/projects/P0013_WGS_patterns_Diagn/datasets/processed/HMF_DR104/scripts/annotate_genes_jesko/raw/CPCT02380011T/CPCT02380011T.purple.somatic.ss.vcf.gz'
